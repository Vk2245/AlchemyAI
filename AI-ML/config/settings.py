...
CEREBRAS_MODEL: str = os.getenv("CEREBRAS_MODEL", "cerebras/llama3.1-70b")
CEREBRAS_EXTRACTION_MODEL: str = os.getenv("CEREBRAS_EXTRACTION_MODEL", "cerebras/llama3.1-70b")
...
GROQ_MODEL: str = os.getenv("GROQ_MODEL", "groq/llama3-70b-8192")
GROQ_EXTRACTION_MODEL: str = os.getenv("GROQ_EXTRACTION_MODEL", "groq/llama3-70b-8192")
